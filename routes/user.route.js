...
const {BASE_URI} = require("./../config/env"),
  ...
  {fetchAllUser, fetchActiveUser, fetchUserByIdorEmail, updateUserByEmail, deleteUserByEmail} = require("./../controller/user/user.controller");
...
module.exports = (route) => {
    ...
    route.get(`${ENDPOINT}user/activeUser`, isLoginMiddleware, tryCatchWrapper(fetchActiveUser))
